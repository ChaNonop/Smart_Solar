...
| [🏗️ System Architecture](#️-system-architecture) | โครงสร้างระบบและ Flowchart |
| [🛠 Tech Stack](#-technologies-used) | อุปกรณ์และเครื่องมือที่ใช้งาน |
...
**Smart Solar** ระบบ IoT สำหรับติดตามและควบคุมการทำงานของแผงโซล่าเซลล์และแบตเตอรี่

**💡 ปัญหา (The Problem):**
โดยปกติแล้ว Solar Charger ทั่วไปตามท้องตลาดหรือมีก็มักจะมีราคาที่สูงมากๆ ส่วนใหญ่ตามท้องตลาด solar charger ทำหน้าที่แค่ควบคุมการทำงาน จ่ายไฟตามเวลาตามเวลาที่เซ็ตไว้ ชาร์จไฟเข้าแบตเตอรี่หรือสวิตส์ไปใช้งานโดยที่ไม่ผ่านแบตเตอรี่ ซึ่งไม่ตอบโจทย์ในโลกยุคใหม่ที่ต้องการความสะดวกและการเข้าถึงที่ง่ายได้ทุกที่ๆมีอินเตอร์เน็ต ข้อจำกัดของการใช้งานระบบทั่วไป คือไม่สามารถเก็บข้อมูล (Data Logging) หรือวิเคราะห์ประสิทธิภาพการชาร์จได้ ทำให้เราไม่ทราบถึงสถานะการทำงาน ระดับพลังงานที่เราผลิตได้ และค่าระดับพลังงานที่ผลิตได้ในภาพรวม
...
|:---:|:---|
| **Hardware** | Soalr Charger PWM, ESP8266 (NodeMCU), Arduino (Nano/Uno), เซ็นเซอร์แรงดัน/กระแส, Relay Module |
